...
let app = new Vue({
    ...
    methods: {
        ...
        addContact: function(){
            if (this.lastName === '' || this.lastName === '' || this.phone === '' || this.email === ''){
                return
            }
            this.contacts.push({
        ...
        deleteContact: function(i) {
            // remove only this item from the dictionary (i) is the current contact
        ...
        toggleModal: function(){
             // Bulma requires this for the modal
